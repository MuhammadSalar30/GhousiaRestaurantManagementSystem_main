        ...
        <div class="p-6 rounded-lg border border-default-200">
            <div class="grid lg:grid-cols-2 gap-6 mb-6">
                <div class="space-y-6">
                    ...
                    {{-- <div>
                        <input class="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="number" placeholder="Quantity in Stock">
                    </div> --}}

                    <div>
                        <select id="orderType" class="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Select Product Category">
                    ...
                    <div>
                        <select id="productSize" class="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50">
