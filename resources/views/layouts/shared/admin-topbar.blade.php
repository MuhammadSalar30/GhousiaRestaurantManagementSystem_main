    ...
    <nav class="flex items-center gap-4 w-full px-6">
        ...
        <div class="lg:hidden flex">
            <a href="{{ route('second', ['admin', 'dashboard']) }}">
             ...
             <img src="/images/assets/logo.png" alt="logo" class="h-12 hidden dark:flex">
                {{-- <img src="/images/logo-dark.png" alt="logo" class="h-10 w-full flex dark:hidden">
                <img src="/images/logo-light.png" alt="logo" class="h-10 w-full hidden dark:flex"> --}}
            </a>
        </div>
        ...
        <div class="flex items-center gap-4 ms-auto">
            ...
            <div class="md:flex hidden">
                <a href="{{ route('second', ['admin', 'settings']) }}" class="inline-flex flex-shrink-0 justify-center items-center gap-2 h-10 w-10 rounded-full font-medium text-default-700 align-middle bg-default-100 hover:text-primary transition-all text-xs">
            ...
            <div class="flex">
                <div class="hs-dropdown relative inline-flex ">
                    ...
                    <div class="hs-dropdown-menu mt-2 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[12rem] shadow-md rounded-lg p-2 border border-default-200 bg-white dark:bg-default-50">
                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-default-800 transition-all hover:bg-default-100" href="{{ route('second', ['admin', 'settings']) }}">
                            <i class="w-4 h-4" data-lucide="user"></i>
                            My Profile
                        </a>
                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-default-800 transition-all hover:bg-default-100" href="{{ route('second', ['client','home']) }}" target="_blank">
